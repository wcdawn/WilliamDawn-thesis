...
\section{Introduction}
  ...
  the \gls{fem}. The strategy employed in this work is developed by 
  \textcite{oberkampf}. The first step is 
...
\section{Two-Dimension Benchmark Solutions}
  ...
  \subsection{IAEA}
    Proposed by \textcite{chao} and described in \sref{sec:iaea},
...
\section{Three-Dimension Benchmark Solutions}
  ...
  \subsection{MONJU}
    ...
    Reference data can be found in \tref{tab:monjukref}. Results from the finite
  ...
  \subsection{KNK}
    ...
    Reference data can be found in \tref{tab:knkkref}. Results from the finite
