...
\section{Necessity of Modeling}
  ...
  PRISM as designed by GE-Hitachi Nuclear Energy (GEH).
...
\section{Model Details}
  ...
  \subsection{Material Properties}
    ...
    \begin{multline}
      ...
      \left( \frac{\Delta L}{L} \right)_{\text{U10Zr}} = \\
        ...
        \end{cases}
    \end{multline}
    for $T$ in \units{K}. Note that U10Zr has a phase change at 923 \units{K} 
    that increases the LEF at this point. The LEF of HT9 and U10Zr over the 
    range of operating temperatures of SFRs are plotted in \fref{fig:lef_plot}. 
  ...
  \label{sec:model_details__assumptions_and_formulae}
    ...
    be defined using \eref{eq:lef_ht9} as
    \begin{equation}
      \label{eq:lef_r}
    ...
    according to \eref{eq:area_ratio}.
    \begin{align}
      ...
      a_i^H &= a_i^C
    \end{align}
    \eref{eq:constant_area_frac} implies that for uniform thermal expansion in 
    ...
    area fractions does not obey \eref{eq:constant_area_frac}. Instead, area 
...
\section{Implementation}
  ...
  \subsection{Cross-section Effects}
    ...
    this into \eref{eq:nden_volume_ratio}.
    \begin{equation}
    ...
    and is given by \eref{eq:volume_ratio}. Inserting \eref{eq:volume_ratio}
    into \eref{eq:nden_expansion_expanded}.
    \begin{equation}
    ...
    \eref{eq:nden_thexp_update} can also be used to update reaction 
...
\section{Results}
  ...
  \fref{fig:thexp_study} and the associate reactivity, calculated as
  \begin{equation}
  ...
  factor of the fuel given in \eref{eq:lef_u10zr} dominates and the phase change 
