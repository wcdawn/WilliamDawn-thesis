...
\section{Implementation}
  ...
  diffusion equation via the \gls{fem} (see \chref{ch:neutronDiffusion}) as well
  ...
  \subsection{Expansion of Elements and Area Fractions}
    ...
    \eref{eq:expand_x}, \eref{eq:expand_y}, and \eref{eq:expand_z}. By expanding
    ...
    previously discussed in \sref{sec:model_details__assumptions_and_formulae},
...
\section{Results}
  ...
  \sref{sec:model_details__assumptions_and_formulae}, the user must input
  ...
  expansion is plotted in \fref{fig:thexp_study} and the associated reactivity,
  calculated as
  \begin{equation}
