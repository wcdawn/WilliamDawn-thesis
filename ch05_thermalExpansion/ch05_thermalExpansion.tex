...
\section{Necessity of Modeling}
  ...
  passive safety of fast reactor designs due in part to the thermal expansion of 
  ...
  The inherent safety demonstration test at EBR-II demonstrated the passive
...
\section{Model Details}
  ...
  \subsection{Material Properties}
    ...
    $923 \units{K}$ that increases the LEF at this point. Both \eref{eq:lef_ht9}
    and \eref{eq:lef_u10zr} evaluate to zero near room temperature. The LEF of 
    HT9 and U10Zr over the range of operating temperatures of fast reactors are 
    plotted in \fref{fig:lef_plot}. It is observed that the LEF of U10Zr is as 
