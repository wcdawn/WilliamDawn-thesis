...
\label{sec:reactivity_coefficients}
  ...
  \label{sec:coolant_temperature_reactivity_coefficient}
    ...
    To calculate $\alpha_{CTC}$, coolant temperature is increased directly. A
    simulation is conducted with feedback for reactor power $Q_{Rx,i}$ and the
    temperature profile is stored. Then, the coolant temperature is uniformly
...
\label{sec:results}
  ...
  \fref{fig:thermal_expansion_reactivity_coefficient}.
