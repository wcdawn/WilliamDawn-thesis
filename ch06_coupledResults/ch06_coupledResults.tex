...
\label{sec:abr}
  ...
  outlined in \sref{sec:cross_section_treatment} resulting in temperature
...
\label{sec:reactivity_coefficients}
  ...
  \label{sec:coolant_temperature_reactivity_coefficient}
    ...
    is positive as is common in FRs. This implies increases in coolant 
    temperature will lead to an increase in reactivity and cause a subsequent 
    increase in reactor power. In FRs, the coolant acts as a parasitic neutron 
    absorber. Therefore, a decrease in the sodium absorption cross-section 
    encourages neutron absorption in fissile material in the fuel resulting in a 
    reactivity increase. This does not pose a stability problem as long as the 
    power reactivity coefficient remains negative.
