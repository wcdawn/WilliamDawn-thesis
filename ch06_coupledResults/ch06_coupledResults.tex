...
\label{sec:abr}
  ...
  agree to within 700 \units{pcm}. The \dif and \gls{fem} models were minimally 
  ...
  collapsed thermal ($\phi_2$) are plotted in \fref{fig:abr_fluxes}.
...
\label{sec:reactivity_coefficients}
  ...
  \subsection{\texorpdfstring{\glsentryfull{ctc}}{Coolant Temperature
    Coefficient (CTC)}}
