...
\section{Formulation of Finite Element Equations}
  ...
  \subsection{Derivation}
    ...
    minimal region. Compact support in this application is chosen such that
    ...
    polynomials are common but for the application presented here, only linear
    ...
    energy group at a time and $\phi_g$ is calculated and stored.
  ...
  \subsection{Quadratures}
    ...
    \begin{equation}
      ...
      \end{pmatrix}
    \end{equation}
    Where $N_P$ is the number of points in the element, $\basis_k(\vr)$ is the
    basis function centered at the $k^{th}$ corner, and for corner cordinates 
    $(x_k,y_k,z_k)$ for $k = 1,2,\ldots,N_P$.
...
\section{Implementation}
  ...
  \subsection{Algorithm}
    ...
    needed. From an isotopic description, $q_{fiss,g}$ is given in 
