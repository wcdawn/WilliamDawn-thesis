...
\section{Implementation}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{snr_paraview}
  ...
  \subsection{Linear System Solution}
    ...
    the Conjugate Gradient (CG) Krylov subspace method. SOR requires 	extit{a priori} 
    ...
    CG method is chosen because it requires no 	extit{a priori} knowledge and produced
