...
\section{Reference Results}
  ...
  \subsection{Triangular Element Manufactured Solutions}
    ...
    \subsubsection{One Dimension, One Group, Fixed Source}
      ...
      problem. The exact solution is derived in \sref{sec:deriv_1dfixedsrc} and
      the solution is presented in \eref{eq:analytic_1dfixedsrc}. Results from
      the convergence study are presented in \tref{tab:1dfixedsrc}.
      \begin{table}
    ...
    \subsubsection{One Dimension, Two Group, Criticality }
      ...
      \eref{twogroupflux2}. Results from the convergence study are presented in 
    ...
    \subsubsection{MONJU}
      \begin{table}
        ...
        \begin{center}
          \begin{tabular}{ccll}
            \toprule
            Pattern & $\keff$ & Rod Worth [$\Delta k$] & 
              Rod Difference [\%$\Delta k$] \\
            \midrule
            \csvreader[
              %head to column names,
              late after line=\\,
