...
\section{Implementation}
  ...
  standard that can be used with visualization tools such as ParaView and VisIt
  \cite{here}. Additionally, open-source C and Python packages exist for easy
  manipulation of the format. Cross sections are specified in either a plain text
  ...
  diffusion equation is solved according to \eref{eq:multigroup_source}.
