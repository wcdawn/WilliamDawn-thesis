...
\section{Introduction}
  ...
  equation and it's application to fast reactors or any standard reactor 
  geometry is straightforward. For typical fast reactor applications, diffusion 
  theory approximates the neutron distribution within the reactor well. 
