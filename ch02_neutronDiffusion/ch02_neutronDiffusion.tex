...
\section{Formulation}
  ...
  \subsection{Matrix Quantities}
    ...
    \subsubsection{Linear Triangles}
      ...
      have been investigated in many applications CITATION. This is a triangle 
      defined by three corner coordinates with basis functions located on each 
      corner.
      
      Originally proposed
      in \cite{textbookwhite}, there are simple expressions for the quantities.
      For a triangle with corners $\{ x_i,y_i \}$.
      \begin{align}
        \int_{\Omega_e} \grad \basis_i(\vr) \cdot \grad \basis_j(\vr) 
    ...
    \begin{algorithm}[H]
      ...
      \While{Power/Outer Iteration}
        ...
        \For{$g=1,G$}
          ...
          \State Calculate element-average $\phi$
        \EndFor
        \State Update $k_{eff}$
