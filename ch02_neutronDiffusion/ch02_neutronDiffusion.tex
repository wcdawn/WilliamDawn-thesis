...
\subsection{Power Iterations}
  ...
  \begin{equation}
    ...
    \mb(\vPhi,\keff) \vPhi = \frac{1}{\keff} \mm \Phi
  \end{equation}
  ...
  % todo add discussion on decay of eigenmodes
  
  It is then shown in \cite{nakamura} that the power method
  described in \eref{eq:power_iteration_e1} and \eref{eq:power_iteration_e2}
