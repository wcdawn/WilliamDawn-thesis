...
\section{Introduction}
  ...
  equation but it's application to Fast Reactors (FRs) or any standard reactor geometry is 
  straightforward. For typical FR applications, diffusion theory
...
\section{Multigroup Neutron Diffusion Equation}
  ...
  described by the set of energies $\{E_g\}$ for $g = 1,2,\ldots,G$ and by in
