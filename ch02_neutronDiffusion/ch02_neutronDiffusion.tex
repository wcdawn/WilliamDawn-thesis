...
\section{Implementation}
  ...
  \subsection{Algorithm}
    ...
    State \ref{state:chi_collapse} normalizes $\chi$ to preserve the fission
    ...
    isotopic description, $q_{fiss,g}$ is given in \eref{eq:isotopic_chi}.
    \begin{equation}
