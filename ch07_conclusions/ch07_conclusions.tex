...
\section{Recommendations for Future Research}
  ...
  \subsection{\texorpdfstring{\glsentrylong{spn}}{Simplified PN} Solution}
    ...
    system of diffusion-like equations. Work by Ryu and Joo has demonstrated
    that the \gls{fem} can be used to solve the \gls{spn} equations in general
    geometry \cite{Ryu2013}. Implementation of the \gls{spn} equations would
