...
\section{Geometry Description}
  ...
  geometry is shown in \fref{fig:reactor_materials}.
  ...
  sodium gaps (see ``Gap'' in \fref{fig:hex_can}).
  \begin{align}
...
\section{Cross-Section Treatment}
  ...
  radial conduction models in \chref{ch:thermalHydraulics}. Temperatures from
  the model are given in \tref{tab:xstemps}.
...
\section{Thesis Organization}
  In \chref{ch:neutronDiffusion}, the derivation of the \gls{fem} solution to the
