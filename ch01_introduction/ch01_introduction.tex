...
\section{Cross Section Treatment}
  ...
  reflector assemblies, the default \isotope[238]{U} fission spectrum is assumed.
  ...
  and radial conduction models in \chref{ch:thermalHydraulics}. Temperatures
  from the model are given in \tref{tab:xstemps}.
