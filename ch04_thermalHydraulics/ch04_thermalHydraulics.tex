...
\section{Introduction}
  ...
  are developed for standard fast reactor geometry as described in
  ...
  common to fast reactors and described in \sref{sec:geometry_description}, 
  satisfy this assumption with canned assemblies to prevent cross-flow between 
  channels and mixing encouraged by wire wrapping. The second model is a 
  steady-state, one-dimensional, radial heat conduction model within a 
...
\section{Material Properties}
  ...
  sodium cooled fast reactors. Therefore, the thermal conductivity of sodium 
  within the bond and HT9 are assumed constant at the average value as reported 
  in \cite{sodiumProp} and \cite{ht9Prop} respectively. These constant values 
  are given in \tref{tab:constant_k}.
...
\section{Cross-Section Treatment}
  ...
  \subsection{Coolant Cross-Sections}
    ...
    is given as a function of temperature $\rho(T)$ by a state relationship in 
