...
\section{Power Normalization}
  ...
  is discussed further in \sref{sec:radial_conduction_model}. Briefly, the
...
\section{Axial Convection Model}
  ...
  \subsection{Geometric Model}
    ...
    channels is shown in \fref{fig:chunk_description}. Elevations are indexed 
    ...
    \begin{figure}
      \centering
      \includegraphics[width=\textwidth]{axial_model}
...
\section{Radial Conduction Model}
  ...
  \subsection{Geometric Model}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.6\textwidth]{radial_model}
  ...
  \subsection{Surface Temperature and Centerline Temperatures}
    ...
    \subsubsection{Temperature in Fuel}
      ...
      \end{equation}
      the evaluations at $r=0$ are zero and \eref{eq:need_bc} can be evaluated.
      \begin{equation}
        \label{eq:dtdr_fuel}
      ...
      \eref{eq:kfuel_first} through \eref{eq:kfuel_last} is analytically
      integrated using a symbolic math computer program and the fuel 
      conductivity integral, $K_F(T)$, is stored in the code. Then,
      \eref{eq:tcl_conductivity_integral} is solved using the bisection method.

      If, instead, $k_F(T)$ were constant such that $k_F(T) = \overline{k_F}$;
      then, \eref{eq:tcl_conductivity_integral} would be equivalent to 
      \begin{align}
        \label{eq:tfr}
    ...
    \subsubsection{Temperature in Sodium Bond}
      ...
      \tref{tab:constant_k}. The steady-state heat conduction equation with no
    ...
    \subsubsection{Temperature in Cladding}
      ...
      as specified in \tref{tab:constant_k}.  Using the expression for
      temperature within the bond, \eref{eq:tf_forward}, the temperature within
    ...
    \subsubsection{Clad Surface Temperature}
      ...
      $D_e$ and $A_x$ are defined according to \eref{eq:correlation_de} and
      \eref{eq:correlation_ax} respectively. The Prandtl number is defined
      according to 
      \begin{equation}
        \label{eq:pr}
        Pr = \frac{c_p \, \mu}{k}
