...
\section{Radial Conduction Model}
  ...
  \subsection{Average Temperatures}
    ...
    \subsubsection{Average Fuel Temperature}
      ...
      \end{align}
      Next, the integral in the numerator of \eref{eq:tfbar_integral} is evaluated.
      \begin{align}
    ...
    \subsubsection{Average Bond Temperature}
      ...
      \end{align}
      With these expressions, \eref{eq:tbbar_integral} can be evaluated by dividing
      \eref{eq:tbbar_numerator} by \eref{eq:tbbar_denominator} and simplifying.
      \begin{equation}
        \label{eq:tb_bar}
