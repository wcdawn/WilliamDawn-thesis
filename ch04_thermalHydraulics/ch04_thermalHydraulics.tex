...
\section{Cross-Section Treatment}
  % todo there is only one subsection. Clean this up.
...
\section{Thermal Hydraulic Results}
  ...
  \subsection{Axial Results}
    ...
    \begin{table}
      ...
      \begin{center}
        \begin{tabular}{clc}
          ...
          \midrule
          $q'_0$      & $2.09 \times 10^8$ &
            $\units{$\frac{\text{W}}{\text{m}}$}$\\
          $\mdot$     & 11.42  &\units{$\frac{\text{kg}}{\text{s}}$} \\
    ...
    \begin{align}
      ...
      &= h_{in} + \frac{q'_0}{\mdot} \left(1 - 
        \cos\left(\frac{\pi \, z}{H}\right)\right)
    \end{align}
