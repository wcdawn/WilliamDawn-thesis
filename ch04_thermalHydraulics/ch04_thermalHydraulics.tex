...
\section{Thermal Hydraulic Results}
  ...
  \subsection{Axial Results}
    ...
    difference between the two results. Average axial temperatures for the
    discrete model are shown in \fref{fig:axial_temp_plot}.
    ...
    \begin{figure}
      ...
      \caption{Axial Temperatures for Model Reactor Conditions.}
