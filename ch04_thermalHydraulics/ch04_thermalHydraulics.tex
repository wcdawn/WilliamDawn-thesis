...
\section{Material Properties}
  ...
  \cite{ht9Prop} are assumed constant. These constant values are given in 
  \tref{tab:constant_k}.
  ...
  Fuel thermal conductivity given in as a function of material
  temperature and zirconium weight fraction \cite{fuelProp}.
  ...
  conductivity, the integral of thermal conductivity is unbounded as 
