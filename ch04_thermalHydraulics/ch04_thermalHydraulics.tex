...
\section{Radial Conduction Model}
  ...
  \subsection{Surface Temperature and Center-Line Temperatures}
    ...
    \eref{eq:chunkqppp_fuel} is assumed constant within the fuel. Additionally,
    ...
    \eref{eq:tcl_integral} does not have a simple forward expression. Solving
    ...
    Alternatively, \eref{eq:tfr_conductivity_integral} allows for the
