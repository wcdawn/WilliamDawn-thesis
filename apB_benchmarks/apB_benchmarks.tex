...
\section{Two-Dimension}
  ...
  \subsection{VVER440}
    ...
    are 25 assemblies across the core diameter. The last ring of assemblies at
    the core periphery are non-fissile reflector assemblies as shown in 
    \fref{fig:vver440_geom}. Each assembly
  ...
  \subsection{\texorpdfstring{\glsentryshort{hwr}}{HWR}}
    ...
    \begin{figure}
      ...
      \caption{\gls{hwr} Geometry.}
      \label{fig:hwr_geom}
    \end{figure}

    \begin{table}
      \caption{\gls{hwr} Cross Sections.}
      \label{tab:hwrxs}
      \begin{center}
        \begin{tabular}{cccccc}
          \toprule
    ...
    \begin{table}
      \caption{\gls{hwr} Fission Spectrum.}
      \label{tab:hwrchi}
      \begin{center}
        \begin{tabular}{cc}
          \toprule
