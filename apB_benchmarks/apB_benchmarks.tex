...
\section{Introduction}
  ...
  application, these tests were used to test the solution to the neutron 
...
\section{Two Dimension}
  ...
  \subsection{SNR}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.8\textwidth]{snr_geom}
  ...
  \subsection{HWR}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=\textwidth]{hwr_geom}
