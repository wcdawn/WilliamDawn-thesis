...
\section{Introduction}
  ...
  \units{$\frac{1}{cm}$} where applicable. 
  ...
  \begin{conditions} % custom environment designed for this purpose
    ...
    \Sigma_{t,g} & macroscopic total cross-section for energy group $g$ 
      \units{$\frac{1}{\text{cm}}$}, \\
    \widetilde{\chi_g} & effective fission spectrum for energy group $g$,\\
...
\section{Two Dimension}
  ...
  \subsection{SNR}
    ...
    measurement of 11.2003 \units{cm}. Vacuum boundary condition ($\albedo =
  ...
  \subsection{IAEA}
    ...
    modification is found in \cite{chao}. The problem is one-twelfth of a 
...
\section{Three-Dimension}
  \subsection{MONJU}
    ...
    in \tref{tab:monjuchi}. In determining this fission spectrum, it is observed
  ...
  \subsection{KNK}
    ...
    difficult as the equations solved are wholly different.
