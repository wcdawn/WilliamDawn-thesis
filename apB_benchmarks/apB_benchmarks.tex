...
\section{Introduction}
  ...
  diffusion equation in \chref{ch:neutronDiffusion}. As such, the cross sections 
  presented are those necessary to solve the multigroup neutron diffusion
  equation. All units are \units{cm} and \units{$\frac{1}{cm}$} where
  applicable. One benchmark presented in \sref{sec:knk} was 
  ...
  cross sections are common to the field and noted in \tref{tab:xssymbols}. 
...
\section{Two Dimension}
  \subsection{VVER440}
    ...
    last ring of assemblies as shown in \fref{fig:vver440_geom}. Each assembly
    has a flat-to-flat measurement of 14.7 \units{cm}. Vacuum boundary
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.6\textwidth]{vver440}
  ...
  \subsection{SNR}
    ...
    assemblies as shown in \fref{fig:snr_geom}. Each assembly has a side-length
    measurement of 6.4665 \units{cm}. Vacuum boundary condition ($\albedo =
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.6\textwidth]{snr}
  ...
  \subsection{HWR}
    ...
    across the core diameter as shown in \fref{fig:hwr_geom}. The fueled
    ...
    \tref{tab:hwrxs}. The fission spectrum is specified in \tref{tab:hwrchi}. To
    the precision of the benchmark, the effective neutron multiplication factor
    is $\keff = 0.991965$. Assembly powers are given in \fref{fig:hwr_geom}.
    \begin{figure}
      \centering
  ...
  \subsection{IAEA}
    ...
    \units{cm}. To the precision of the benchmark, the cross sections are
    summarized in \tref{tab:iaeakeff}.
    Assembly geometry and powers is provided for without and with 
    reflector in \fref{fig:iaea_nore_geom} and \fref{fig:iaea_refl_geom} 
    respectively. All cross sections are provided in \tref{tab:iaeaxs}. Fission
    spectrum is provided in \tref{tab:iaeachi}.
    \begin{table}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.6\textwidth]{iaea_nore}
      \caption{IAEA Without Reflector Geometry.}
      \label{fig:iaea_nore_geom}
    \end{figure}
    \begin{figure}
      \centering
      \includegraphics[width=0.6\textwidth]{iaea_refl}
...
\section{Three Dimension}
  \subsection{MONJU}
    ...
    Each assembly has a side-length measurement of 6.67417 \units{cm}. Vacuum
    ...
    occupy 0 \units{cm} to 151.5 \units{cm}. Reference effective neutron
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.6\textwidth]{monju_geom}
  ...
  \subsection{KNK}
    ...
    steel as shown in \fref{fig:knk_geom}. Each assembly has a side-length
    measurement of 7.50 \units{cm}. Vacuum boundary condition ($\albedo = 0.5$)
    ...
    axial geometries are described in \fref{fig:knk_cr_geom}. Reference
    ...
    \begin{figure}
      \centering
      \includegraphics[width=\textwidth]{knk_geom}
      \caption{KNK Geometry \cite{takedaBenchmark}.}
      \label{fig:knk_geom}
    \end{figure}
    \begin{figure}
      \centering
      \includegraphics[width=0.6\textwidth]{knk_cr_geom}
