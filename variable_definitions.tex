...
% thermalExpansion
\newcommand{\texp}
  {\ensuremath{{T_{\!\mbox{\scriptsize \em exp}}}}\xspace}
\newcommand{\texpfuel}
  {\ensuremath{{T_{\!\mbox{\scriptsize \em exp,fuel}}}}\xspace}
\newcommand{\texpstruct}
  {\ensuremath{T_{\!\mbox{\scriptsize \em exp,struct}}}\xspace}

% coupledResults
\newcommand{\leakage}{\ensuremath{\mathcal{L}}}


% general macros
\newcommand{\units}[1]{\xspace\ensuremath{\left[\text{{#1}}\right]}}
...
\newenvironment{conditions}
  ...
  l}}{\end{tabular}\par\vspace{0.5\baselineskip}}
