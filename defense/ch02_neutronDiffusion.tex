...
\begin{frame}{Finite Element Neutron Diffusion}
  \begin{itemize}
    ...
    \item Solve multigroup neutron diffusion equation via Finite Element Method
      (FEM).
    \item FEM allows for modern techniques.
    \item Allows for solution refinement without mesh refinement.
  \end{itemize}
\end{frame}
...
\begin{frame}{Collapsing $\chi$}
  \begin{itemize}
    \item Typically isotopic material data is specified.
...
\begin{frame}{Flat-source Elements}
