...
reader.SetFileName("../data/cir0.txt")
reader.Update()
...
plt.axis("off")
plt.tight_layout()
plt.savefig("../figs/cir0.pdf", bbox_inches="tight", pad_inches=0)
plt.close()

# load a vtk file as input
reader = vtk.vtkUnstructuredGridReader()
reader.SetFileName("../data/cir2.txt")
reader.Update()
output = reader.GetOutput()
...
plt.axis("off")
plt.tight_layout()
plt.savefig("../figs/cir2.pdf", bbox_inches="tight", pad_inches=0)
plt.close()
