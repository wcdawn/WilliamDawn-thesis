...
\section{One-Dimension, One-Group, Fixed Source}
  ...
  \begin{equation}
    ...
    \phi(x) = \frac{q_{fixed}}{D\,\kappa^2} \left( 1-\cosh(\kappa\,x) \right) +
    \frac{\frac{q_{fixed}}{D\,\kappa^2} 
...
\section{One-Dimension, One-Group, Two Region, Criticality}
  ...
  \begin{align}
    ...
    \phi_R(x) &= \phi_0 \, \cos(B_F \, L_F) \, \cosh(B_R \, (x-L_F)) - 
      \frac{\phi_0 \, D_F \, B_F \, \sin(B_F\,L_F)}{D_R \, B_R} \, 
      \sinh(B_R\,(x-L_F)) \\
...
\section{Finite-Cylinder, One-Group, Criticality}
  ...
  \begin{equation}
    ...
    B^2 = \frac{\frac{1}{\keff} \nu \Sigma_f - \Sigma_r }{D}
  \end{equation}
  The Laplacian in \eref{eq:finite_cyl_buckle} is expanded noting two dimension
