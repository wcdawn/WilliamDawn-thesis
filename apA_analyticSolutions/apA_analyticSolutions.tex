...
\section{Two Dimension, One Group, Criticality}
  ...
  \begin{equation} \label{eq:analtyic_2d1g}
...
\section{Finite Cylinder, One Group, Criticality}
  ...
  directions. This derivation is similar to that in \sref{sec:2d1g}. Beginning
  with the one group neutron diffusion equation \eref{eq:onegroup} and assuming
