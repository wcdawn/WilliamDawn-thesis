...
\section{Introduction}
  ...
  \end{conditions}
   ...
   (homogeneous materials). For problems considered here, material constants
...
%
  ...
  given in \tref{tab:2reg_constants}, the following are solutions. Note $B_F$ is
  given to approximately machine precision (16 significant digits) as the
  solution is particularly sensitive to this value. Additionally,
